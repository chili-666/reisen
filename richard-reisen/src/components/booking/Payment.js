                ...
                <div className="box">
                    ...
                    <div className="columns">
                        ...
                        <div className="column">
                            {this.state.agb ?
                            <div>
                               <Link to="/buchung-erstellt" booking={this.state}> 
                            <button className="button is-primary is-rounded is-small" style={{marginBottom:"1em"}}>Per Überweisung</button> 
                            </Link>
                                 <Paypal />
                                 </div>
                                 :
                                 <div className="box has-background-warning has-text-black is-size-7">
                                     Bitte lesen und akzeptieren Sie unsere AGB vor der Buchung
                                     </div>}
                        </div>
                    </div>
                    </div>
